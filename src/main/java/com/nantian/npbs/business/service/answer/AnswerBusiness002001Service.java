...
@Scope("prototype")
@Component
public class AnswerBusiness002001Service extends  AnswerBusiness001Service{

	private static Logger logger = LoggerFactory.getLogger(AnswerBusiness002001Service.class);
