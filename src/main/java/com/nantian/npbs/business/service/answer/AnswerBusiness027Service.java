...
@Scope("prototype")
@Component
public class AnswerBusiness027Service extends AnswerBusinessService {

	private static Logger logger = LoggerFactory.getLogger(AnswerBusiness027Service.class);
