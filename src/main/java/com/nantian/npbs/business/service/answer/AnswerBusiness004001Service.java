...
@Scope("prototype")
@Component
public class AnswerBusiness004001Service extends  AnswerBusiness001Service{

	private static Logger logger = LoggerFactory.getLogger(AnswerBusiness004001Service.class);
