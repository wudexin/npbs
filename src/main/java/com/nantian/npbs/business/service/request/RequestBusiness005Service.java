...
@Scope("prototype")
@Component
public class RequestBusiness005Service extends RequestBusinessService {

	private static Logger logger = LoggerFactory.getLogger(RequestBusiness005Service.class);
	...
	protected void dealBusiness(ControlMessage cm,BusinessMessage bm) {
		logger.info("备付金明细查询，无request业务逻辑");
