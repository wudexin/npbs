...
@Scope("prototype")
@Component(value="WebAnswerBusiness025002Service")
public class WebAnswerBusiness025002Service extends WebAnswerBusinessService {

	private static Logger logger = LoggerFactory
			.getLogger(WebAnswerBusiness025002Service.class);
	...
	public void dealBusiness(ModelSvcReq modelSvcReq, ModelSvcAns modelSvcAns) {
		logger.info("开始业务处理");
			...
			if(!payPrepay(modelSvcReq, modelSvcAns)){
				return;
			} 
			logger.info("业务处理成功");
	}
