...
@Scope("prototype")
@Component
public class RequestBusiness014Service extends RequestBusinessService {

	private static Logger logger = LoggerFactory.getLogger(RequestBusiness014Service.class);
	
	@Override
	protected boolean checkCommon(ControlMessage cm,BusinessMessage bm) {
		// 终端查询交易明细（指定业务种类）无公共校验
		return true;
	}
