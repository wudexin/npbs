...
import com.nantian.npbs.core.orm.AbstractDao;

/**
 * GenericHibernateDao 继承 SpringHibernateDaoSupport，封装 HibernateTemplate 各项功能，
 * 
 * @author wangwei
 */
@SuppressWarnings("unchecked")
public class GenericHibernateDao<T, PK extends Serializable> extends
		HibernateDaoSupport implements AbstractDao<T, PK> {
	// 实体类类型(由构造方法自动赋值)
