 ...
 */
@Component
public class WEBSTRINGPacketxxx019Helper implements IPacketWEBSTRING {
	...
	public void pack(Map<String, Object> fieldValues, ControlMessage cm,
		...
		//备付金账号
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_PREPAY_ACCNO", bm.getPrePayAccno());
		
		//账户余额
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ACC_BALANCE", Double.toString(bm.getPreBalance()));
