 ...
 */
@Component
public class WEBSTRINGPacketxxx010Helper implements IPacketWEBSTRING {
	...
	public void pack(Map<String, Object> fieldValues, ControlMessage cm,
		...
		//原交易EPOS流水号
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_EPOS_ORI_SEQNO", bm.getPosJournalNo());
		...
		//原交易PB流水号
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_SYS_ORIGSEQNO", bm.getOldPbSeqno());
		...
		if(bm.getTranType() != null){
			if("02".equals(bm.getTranType())){
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_BUSI_CODE", "999");
			}else{
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_BUSI_CODE", bm.getBusinessType());
			}
		}else{
