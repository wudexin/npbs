 ...
 */
@Component
public class ISO8583Packet006001Helper extends ISO8583Packetxxx001Helper {
	
	private static Logger logger = LoggerFactory
			.getLogger(ISO8583Packet006001Helper.class);
...
//		return str.toString();
		...
		str.append("欠费金额:").append(wcd.getSumFee()).append("\n");
