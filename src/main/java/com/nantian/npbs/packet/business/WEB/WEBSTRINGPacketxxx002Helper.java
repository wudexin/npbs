 ...
 */
@Component
public class WEBSTRINGPacketxxx002Helper implements IPacketWEBSTRING {

	private static final Logger logger = LoggerFactory
				.getLogger(WEBSTRINGPacketxxx002Helper.class);
	...
	public void pack(Map<String, Object> fieldValues, ControlMessage cm,
		...
		//资金归集方式
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_PAY_TYPE", bm.getPayType());
		...
		if( bm.getCustomData() != null ){
			...
			if("005002".equals(bm.getTranCode())){
				...
				//本次余额
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_ACCBAL", hdCashData.getThisAmt());
				//抄表期间
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_SENUM", hdCashData.getHd_month());
				//阶梯信息
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_HEE_JTDJXX", "");
			...
			if("007002".equals(bm.getTranCode())){
				...
				//账户余额
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_ACCBAL", cash.getThisBalance());
				//起止示数
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_SENUM", cash.getSeNum());
				...
				//阶梯信息
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_HEE_JTDJXX", jtdjxx.toString());
			...
			if("009002".equals(bm.getTranCode())) {
				...
				//账户余额
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_TV_CASH_ACCBAL", String.valueOf(nowBalance));
				
				//起止示数
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_SENUM", "");
			...
			if("002002".equals(bm.getTranCode())) {
				...
				//账户余额
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_ACCBAL", str1.toString());
				//起止示数
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_CASH_SENUM", str2.toString());
				
				//阶梯信息
				WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_ELEC_HEE_JTDJXX", str3.toString());;
		...
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_LOW_TIP", msg.toString());
