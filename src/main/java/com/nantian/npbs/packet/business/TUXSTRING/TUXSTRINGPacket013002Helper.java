...
/**
 * 华电IC卡卡表缴费（调用电商华电现金接口）
 * @author MDB
 *
 */
@Component
public class TUXSTRINGPacket013002Helper extends TUXSTRINGPacketxxx002Helper {

private static Logger logger = LoggerFactory.getLogger(TUXSTRINGPacket013002Helper.class);
