 ...
 */
@Component
public class ISO8583Packet010024Helper extends ISO8583Packetxxx024Helper {
	private static Logger logger = LoggerFactory
			.getLogger(ISO8583Packet010024Helper.class);
	...
	protected String packField55(BusinessMessage bm) {
		logger.info("河电IC卡申请撤销写卡--打包55位元--开始");
		...
		try {
			...
			logger.error("河电IC卡申请撤销写卡--打包55位元出错", e);
		}
		logger.info("河电IC卡申请撤销写卡--打包55位元--结束");
		return buffer;
	}
	...
	protected void unpackField55(Object field, BusinessMessage bm) {
		...
		logger.info("河电IC卡申请撤销写卡--解包55位元--开始");
		...
		try {
			...
			logger.error("河电IC卡申请撤销写卡--解包55位元出错", e);
		}

		bm.setCustomData(icData);
		logger.info("河电IC卡申请撤销写卡--解包55位元--结束");
	}
