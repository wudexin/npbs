 ...
 */
@Component
public class TUXSTRINGPacket014001Helper extends TUXSTRINGPacketxxx001Helper{

	private static Logger logger = LoggerFactory.getLogger(TUXSTRINGPacket014001Helper.class);
	...
	public void unpack(Map<String, Object> fieldValues, ControlMessage cm, BusinessMessage bm) 
		...
		String levAmt = (String) fieldValues.get("D13_13_HBE_LEV_AMT");
		if(levAmt==null) throw new PacketOperationException();
		cash.setLevAmt(levAmt);
