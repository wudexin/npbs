 ...
 *
 */
public class WEBSTRINGFieldsConfig extends FieldsConfig {
	...
	protected  void initFieldConfig() {
		...
		//返回数据
		f = new Field("D_RET_DATA", VariableType.ASCII, LengthType.FIXED, 0, 100, AlignType.RIGHTSPACE, "retData");
		addFieldConfig(f.getName(), f);
		...
		addFieldConfig(f.getName(), f);
		//类55域：电卡数据
		f = new Field("D_web_55", VariableType.ASCII, LengthType.FIXED, 0, 999, AlignType.RIGHTSPACE, "Web55");
		addFieldConfig(f.getName(), f);
		//类44域：响应信息，打印数据
		f = new Field("D_web_44", VariableType.ASCII, LengthType.FIXED, 0, 512, AlignType.RIGHTSPACE, "Web44");
		addFieldConfig(f.getName(), f);
		//商户编号
		f = new Field("D_CONS_NO", VariableType.ASCII, LengthType.FIXED, 0,16, AlignType.RIGHTSPACE, "consno");
		addFieldConfig(f.getName(), f);
	}
	...
	public static FieldsConfig getInstance() {
		if (instance != null)
			return instance;
		instance = new WEBSTRINGFieldsConfig();
		return instance;
	}
