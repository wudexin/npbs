 ...
 */
@Component
public class ISO8583Packet004001Helper extends ISO8583Packetxxx001Helper {
	private static final Logger logger = LoggerFactory.getLogger(ISO8583Packet004001Helper.class);
