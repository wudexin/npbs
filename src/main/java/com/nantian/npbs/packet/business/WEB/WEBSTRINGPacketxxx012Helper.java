 ...
 */
@Component
public class WEBSTRINGPacketxxx012Helper implements IPacketWEBSTRING {
	
	private static Logger logger = LoggerFactory
	.getLogger(WEBSTRINGPacketxxx012Helper.class);
	...
	public void pack(Map<String, Object> fieldValues, ControlMessage cm,
		...
		//自定义域
		WEBSTRINGPacketUtils.addFieldValue(fieldValues, "D_CUSTOM_FIELD", "000012");
