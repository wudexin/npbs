...
@Scope("prototype")
@Component
public class WEBSTRINGPacketHelper implements IPacket {

	private static Logger logger = LoggerFactory
			.getLogger(WEBSTRINGPacketHelper.class);
	...
	@Resource
	public WEBSTRINGPacketHeaderHelper headerHelper;
	...
	public Map<DATA_TYPE, Object> unpackObject(Map<DATA_TYPE, Object> message)
		...
		try {
			packetHelper = (IPacketWEBSTRING) SpringContextHolder
...
//						bm.setResponseCode("01");
	...
	private static String getPacketBeanName(String tranCode) {
		...
		return "WEBSTRINGPacket" + tranCode + "Helper";
	}
}
