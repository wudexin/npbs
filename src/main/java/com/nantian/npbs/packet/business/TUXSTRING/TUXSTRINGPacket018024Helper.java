 ...
 */
@Component
public class TUXSTRINGPacket018024Helper extends TUXSTRINGPacketxxx024Helper {

	private static Logger logger = LoggerFactory
			.getLogger(TUXSTRINGPacket018024Helper.class);
	...
	public void pack(Map<String, Object> fieldValues, ControlMessage cm,
		...
		PacketUtils.addFieldValue(fieldValues,"D13_13_HEND_PURP_AMT",String.valueOf(bm.getAmount()));//冲正金额
		...
		PacketUtils.addFieldValue(fieldValues,"D13_13_HEND_PAY_ORGNO",cardData.getPAY_ORGNO());//核算单位 
	}
	...
	public String[] hasFields() {
		String[] fields = { "D13_13_HEND_PURP_TIMES",//购电次数              
				...
				"D13_13_HEND_SERIAL_NUMBER"//外部售电系统冲正流水号
		};
		return fields;
	}
