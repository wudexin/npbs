...
public class AnswerBusiness014ServiceTest {

	private static Logger logger = LoggerFactory
			.getLogger(AnswerBusiness014ServiceTest.class);

	@Resource
	private AnswerBusiness014Service answerBusiness014Service;
...
//		bm.setShopCode("05001022"); // 商户
		...
		answerBusiness014Service.dealBusiness(cm, bm);
...
//			assertEquals(tb.getId().getPbSerial(), "20110902293723");
			...
			logger.info("商户号：{}",tb.getCompanyCode());
