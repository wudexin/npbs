...
public class AnswerBusiness018ServiceTest {

	private static Logger logger = LoggerFactory
			.getLogger(AnswerBusiness018ServiceTest.class);

	@Resource
	private AnswerBusiness018Service answerBusiness018Service;
	...
	public void testDealBusiness() {
		logger.info("test AnswerBusiness018Service begin:");
		ControlMessage cm = new ControlMessage();
		BusinessMessage bm = new BusinessMessage();
	    bm.setPbSeqno("20110906294213");
	    answerBusiness018Service.dealBusiness(cm, bm);
