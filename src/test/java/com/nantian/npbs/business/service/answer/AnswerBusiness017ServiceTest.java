...
public class AnswerBusiness017ServiceTest {

	private static Logger logger = LoggerFactory
			.getLogger(AnswerBusiness017ServiceTest.class);

	@Resource
	private AnswerBusiness017Service answerBusiness017Service;
	...
	public void testDealBusiness() {
		logger.info("test Business017Service begin!");
		ControlMessage cm = new ControlMessage();
		BusinessMessage bm = new BusinessMessage();
		
		cm.setResultCode("000000");
		bm.setBusinessType("017");
...
//		bm.setQueryEndDate("20111231");
		...
		bm.setAmount(100.0);
		answerBusiness017Service.dealBusiness(cm, bm);
